  ...
  return (
    <>
      ...
      <footer className="p-2" >
        <div className="mt-8 bg-white dark:bg-gray-900 border border-sky-200 rounded-md">
          <div className="mx-auto w-full max-w-screen-xl py-6 lg:py-8 ">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com/" className="flex items-center">
                  <img src="./logo.svg" className="h-8 me-3" alt="FlowBite Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ModelNote</span>
                </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <a href="https://flowbite.com/" className="hover:underline">Help Guide</a>
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <a href="https://github.com/harris-ryder" className="hover:underline ">Github</a>
                    </li>
                    <li>
                      <a href="https://discord.gg/yT2ZRC3znN" className="hover:underline">Discord</a>
                    </li>
                  </ul>
                </div>
                <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://modelnote.io/" className="hover:underline">ModelNote™</a>. All Rights Reserved.
              </span>
              <div className="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="https://discord.gg/yT2ZRC3znN" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                ...
                <a href="https://x.com/H5Ryder" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                ...
                <a href="https://github.com/harris-ryder" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
